...
class ReleaseNotesGenerator:
    ...
    def __init__(
        ...
        self.adapter: Optional[GitHubKitAdapter] = None
        ...
        try:
            ...
            if not undocumented:
                ...
                return ReleaseNotesResult(
                    status=ReleaseNotesStatus.UP_TO_DATE,
                    version=release_versions[0] if release_versions else None
                )
            ...
            for version in undocumented:
                ...
                current_content = writer.insert_release_notes(
                    current_content,
                    generated_content,
                    version
                )
